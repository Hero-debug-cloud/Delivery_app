...
class _PhoneInputScreenState extends State<PhoneInputScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final primaryColor = isCustomer ? const Color(0xFF16A34A) : const Color(0xFF2563EB);
    final lightPrimaryColor = isCustomer ? const Color(0xFFDCFCE7) : const Color(0xFFDBEAFE);
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // App icon + brand with dynamic gradient
                      Center(
                        child: Column(
                          children: [
                            AnimatedContainer(
                      ...
                      // Role Switcher Tabs (Sleek Glassmorphism/Neutral look)
                      Container(
                        height: 50,
                      ...
                      const Text(
                        "We'll send a 6-digit login code to your phone.",
                      ...
                      // Send OTP button with dynamic theme coloring
                      SizedBox(
